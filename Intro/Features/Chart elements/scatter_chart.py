...
st.subheader("1: Example of st.scatter_chart")
...
scatter_chart = pd.DataFrame(var_dic_data_1, index= (1,2,3,4,5,6))

st.dataframe(scatter_chart,hide_index=False,width=700)
...
st.scatter_chart(scatter_chart, x="Score 1",y="Score 2",color="#ffaa00", size='Score 2')
...
# syntax 
# st.scatter_chart(data=None, *, x=None, y=None, color=None, size=None, width=0, height=0, use_container_width=True)
st.subheader("2: Example of st.scatter_chart")
...
scatter_chart = pd.DataFrame(var_dic_data_1, index= (1,2,3,4,5,6), columns=["Score 1", "Score 2", "Score 3"])

st.dataframe(scatter_chart,hide_index=False,width=700)

st.subheader("Dont Specify only three columns")
st.scatter_chart(scatter_chart, color=["#fd0", "#f0f", "#04f"])
...
st.subheader("3: Example of st.scatter_chart. Scores generated randomly")
...
st.scatter_chart(chart_data, x="Score 1", y="Score 2", color="Score 3")
